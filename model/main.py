...
batch_size = 32
epochs = 5
train_path = "model/archive/asl_alphabet_train/asl_alphabet_train"
test_path = "/model/archive/asl_alphabet_test/asl_alphabet_test"
...
download_model = hub.KerasLayer(hub.load(url), input_shape=(img_size, img_size, 3))
